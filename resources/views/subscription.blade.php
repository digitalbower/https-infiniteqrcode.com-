        ...
        <div class="bg-gray-700 border border-gray-700 rounded-lg shadow-lg overflow-hidden ">
          <div class="md:p-6 p-2 ">
            ...
            <div class="flex gap-6 mb-6">
              ...
              <div class="flex items-center gap-2">
                <i class="fas fa-calendar-days text-gray-400"></i>
                <span class="text-sm">Next Billing:</span>
              </div>
            </div>
            <div class="bg-blue-900 border border-blue-700 rounded-lg p-4 mb-6">
              <div class="flex items-start">
                <i class="fas fa-exclamation-circle text-blue-400 mt-1 mr-3"></i>
                  ...
                  <div>
                    <h4 class="text-blue-100 font-semibold">Upgrade Your QR Code Experience</h4>
                    <p class="text-blue-200"> You're currently on the Basic Plan. Upgrade before to unlock advanced features and manage more QR codes! </p>
                  </div>
                
                  <div>
                    <h4 class="text-blue-100 font-semibold"> Reach the Top with Expert Plan.</h4>
                    <p class="text-blue-200"> You're on the Pro Plan. Upgrade before  to enjoy the ultimate features and unlimited QR code management with the Expert Plan! </p>
                  </div> 
                  <div>
                    <h4 class="text-blue-100 font-semibold"> Stay at the Top! </h4>
                    <p class="text-blue-200"> You're on the highest plan—Expert. Renew before  to continue enjoying premium features and unlimited flexibility! </p>
                  </div>
              ...
              <div>
                ...
                <p class="text-sm text-gray-400">
                  Your auto-renew option is disabled. Renew your plan before to continue enjoying uninterrupted access to all features and benefits.
                </p>
              </div>
              ...
              <div>
                ...
                <p class="text-sm text-gray-400">
                  Your plan has been canceled. Reactivate before [] to regain access to all features and benefits.
                </p>
              </div>
            ...
            <input type="hidden" value="" id="subscribe" name="subscribe">
                  ...
                  <table class="w-full">
                    ...
                    <tbody>
                          ...
                          <tr class="border-b border-gray-700">
                            ...
                            <td class="py-3 px-4 text-gray-300"></td>
                            <td class="py-3 px-4">
                              <a href="" target="_blank" class="text-blue-400 hover:text-blue-300 transition duration-300">
