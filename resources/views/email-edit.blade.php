        ...
        <div class="lg:lg:lg:grid lg:p-8 p-4 mb-6 bg-gray-950 rounded-lg border-gray-900 border shadow-sm gap-x-6 grid-cols-12">
          <div class="col-span-8">
            <form  id="editemailqr_form" style="margin-bottom: 1rem;" action="{{ route('update-emailqr',$email->code) }}" method="POST">
              ...
              <input type="hidden" name="url" id="url" value="{{route('preview-email',$email->code)}}">
                                ...
                                <div class="w-full p-3 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">                           
                                  ...
                                  <div class="relative">
                                      <button type="button" id="folderDropdownButton"
                                          ...
                                          <span id="selectedFolder">{{ $email->folder_name ?? 'Select a folder' }}</span>
                                      ...
                                      <div id="folderDropdown" class="hidden absolute z-10 w-full bg-white border border-gray-300 rounded shadow mt-1">
                                          ...
                                          <ul id="folderList" class="divide-y divide-gray-200">
                                              @foreach ($folders as $folder)
                                                  @php
                                                      $isSelected = isset($email->folder_name) && $email->folder_name == $folder->name ? 'bg-gray-200 font-bold' : '';
                                                  @endphp
                                  ...
                                  <input id="folderinput" type="hidden" name="folderinput" value="{{ $email->folder_name ?? '' }}" />
                                </div>                            
