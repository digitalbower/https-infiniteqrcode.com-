                ...
                <div
                  ...
                  <div class="p-2 pb-0">
                    ...
                    <div class="flex justify-between items-center mb-2"><span class="text-gray-400">Plan Validity</span><span
                        class="text-green-500">Valid till {{ $formattedDate }}  ({{$diffTotal - 1}} Days)</span></div>
                  </div>
                </div>
                ...
                <div
                  ...
                  <div class="p-2 pb-0" id="active-qr">
                    <div class="flex justify-between items-center mb-2"><span class="text-gray-400">Active QR Codes</span><span
                        class="text-white">{{$totalCount}}</span></div>
                    <div class="flex justify-between items-center mb-2"><span class="text-gray-400">Static: </span><span
                        class="text-white"><label class="">{{$staticCount}}</label> out of {{$static}}</span></div>
                          ...
                          @if (count($qrCodes) === 0)
                            ...
                            <tr class="border-b transition-colors data-[state=selected]:bg-muted hover:bg-muted/50"
                              ...
                              <td colspan="4" class="p-4 text-center text-gray-500">
                                ...
                                <button onclick="location.href='{{route('createqrcode')}}'" class="mt-4 bg-primary text-white py-2 px-4 rounded-md hover:bg-primary/90">Create QR
                                  Code</button>
                              </td>
                            </tr> 
                            @endif
                            ...
                            <tr class="border-b border-gray-600 transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                              <td class="p-4 align-middle text-center">
                                <div class="flex justify-center">
                                  <img
                                    src="{{asset('storage/qrcodes/'.$row['code'].'.svg')}}"
                                    alt="Protocol Logo"
                              ...
                              <td class="p-4 text-center">
                                <a href="{{asset('storage/qrcodes/'.$row['code'].'.svg')}}" class="bg-primary text-white py-1 px-3 rounded-md hover:bg-primary/90" download="">Download</a>
                              </td>
