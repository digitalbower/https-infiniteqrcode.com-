...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; text-align: center;">
    ...
    <div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
        ...
        <a href="{{ $data->subscription_link }}" style="background: #ff6600; color: #fff; padding: 12px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 10px;">
            Upgrade Now
        </a>

        <p>If you have any questions, feel free to <a href="{{ $data->support_link }}">contact our support team</a>.</p>

        <p>Thank you for being part of INFINITEQRCODE.COM! 💙</p>

        <p>Best Regards, <br>  
        <strong>The INFINITEQRCODE.COM Team</strong></p>
