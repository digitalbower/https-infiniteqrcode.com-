...
@section('title', 'Edit Video Qr Code')
@section('content')
                              ...
                              <div class="w-full p-3 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">                           
                                ...
                                <div class="relative">
                                    <button type="button" id="folderDropdownButton"
                                        ...
                                        <span id="selectedFolder">{{ $video->folder_name ?? 'Select a folder' }}</span>
                                    ...
                                    <div id="folderDropdown" class="hidden absolute z-10 w-full bg-white border border-gray-300 rounded shadow mt-1">
                                        ...
                                        <ul id="folderList" class="divide-y divide-gray-200">
                                            @foreach ($folders as $folder)
                                                @php
                                                    $isSelected = isset($video->folder_name) && $video->folder_name == $folder->name ? 'bg-gray-200 font-bold' : '';
                                                @endphp
                                ...
                                <input id="folderinput" type="hidden" name="folderinput" value="{{ $video->folder_name ?? '' }}" />
                              </div>                            
                                                     ...
                                                     <div class="relative aspect-[9/16] bg-gray-800">
                                                         ...
                                                         <div id="video-container"
                                                             ...
                                                             <video id="video-player" controls
                                                                 ...
                                                                 src="{{ Storage::disk('public')->exists($video->videopath) ? asset('storage/'.$video->videopath) : 'https://videos.pexels.com/video-files/3209663/3209663-uhd_2560_1440_25fps.mp4' }}">
