        ...
        <div class="container mx-auto pb-12 md:px-6 sm:px-8 lg:px-12">
          ...
          <div
            ...
            <div class="col-span-8">
              ...
              <div
              class="lg:p-8 p-4 mb-6 bg-white rounded-lg border-gray-100 border shadow-sm">
                ...
                <div>
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    ...
                    <input type="tel" placeholder="Fax"
                      class="border rounded-md p-2 focus:ring-2 focus:ring-blue-500 col-span-2 md:col-span-1" />
                  </div>
                </div>
                    ...
                    <div class="space-y-10">
                      ...
                      <div>
                        ...
                        <div class="flex gap-x-4 items-center mt-2">
                          <button
                            class="p-3.5 mt-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:bg-gray-100 transition duration-300">
                          ...
                          <div
                            class="w-full p-4 mt-2 border flex justify-center border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
