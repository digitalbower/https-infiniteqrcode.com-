                ...
                <div class="mx-auto p-4 bg-white">
                    <form class="">
                        ...
                        <div class="relative mb-6">
                            <label for="event-name" class="font-semibold text-gray-700 mb-2 block">Event Name:</label>
                            <input
                                type="text"
                                id="event-name"
                                name="event-name"
                                placeholder="Enter event name"
                                class="w-full border border-gray-300 rounded-md p-3 text-base outline-none focus:ring-2 focus:ring-green-600"
                            />
                        ...
                        <div class="relative mb-6">
                            <label for="event-description" class="font-semibold text-gray-700 mb-2 block">Event Description:</label>
                            <textarea
                       ...
                       <div class="md:flex md:space-x-4">
                        <div class="relative mb-6 w-full" >
                            <label for="start-date" class="font-semibold text-gray-700 mb-2 block">Start Date:</label>
                            <input
                                type="date"
                                id="start-date"
                                name="start-date"
                        ...
                        <!-- End Date Input -->
                        <div class="relative mb-6 w-full" >
                            <label for="end-date" class="font-semibold text-gray-700 mb-2 block">End Date:</label>
                            <input
                                type="date"
                                id="end-date"
                                name="end-date"
                        ...
                        <!-- Location Input -->
                        <div class="relative mb-6">
                            <label for="location" class="font-semibold text-gray-700 mb-2 block">Location:</label>
                            <input
                                type="text"
                                id="location"
                                name="location"
