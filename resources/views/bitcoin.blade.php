        ...
        <div class="container mx-auto pb-12 md:px-6 sm:px-8 lg:px-12">
          ...
          <div
            ...
            <div class="col-span-8">
              ...
              <form style="margin-bottom: 1rem;" id="saveForm" onsubmit="return false;">
                <div
                  ...
                  <input type="text" id="Currency" name="Currency" placeholder="Currency"  style="width: 100%; border: 1px solid #ccc; padding: 0.5rem; border-radius: 4px; box-sizing: border-box;"
                      >
              </div>
  
              <div class="qr-container mt-3">
                  <label style="font-weight: bold; margin-bottom: 0.5rem; display: block;">Quantity</label>
                  <input type="number" id="qty" name="qty"  placeholder="Quantity" style="width: 100%; border: 1px solid #ccc; padding: 0.5rem; border-radius: 4px; box-sizing: border-box;">
              </div>
                      <div class="qr-container mt-3">
